...
@interface SceneDelegate () <UIWindowSceneDelegate, UISplitViewControllerDelegate, UINavigationControllerDelegate>
...
- (void)scene:(UIScene *)scene willConnectToSession:(UISceneSession *)session options:(UISceneConnectionOptions *)connectionOptions {
    ...
    //SceneSplitViewController *splitViewController = (SceneSplitViewController *)self.window.rootViewController;
    SceneViewController *sceneViewController = (SceneViewController *)self.window.rootViewController;
...
//    navigationController.topViewController.navigationItem.leftBarButtonItem = splitViewController.displayModeButtonItem;
   ...
   // splitViewController.delegate = self;
    //splitViewController.persistentContainer = ((AppDelegate *)UIApplication.sharedApplication.delegate).persistentContainer;
    sceneViewController.persistentContainer = ((AppDelegate *)UIApplication.sharedApplication.delegate).persistentContainer;
